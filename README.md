...
5. check the hex value following the line marked 18 (18 in hex is 24 in decimal, this location matches the documentation in [wiki](https://en.wikipedia.org/wiki/Extended_Display_Identification_Data#EDID_1.4_data_format))

...
11. find the difference in the value you just changed (in my example the difference is E0 (since EA was the value before, i replace that value with 0A, so EA-0A is the difference). Add this difference to the last BYTE (for me: E0 + B9)
